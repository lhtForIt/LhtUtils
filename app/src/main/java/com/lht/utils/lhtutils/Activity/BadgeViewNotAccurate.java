...
public class BadgeViewNotAccurate extends TextView {

    private boolean mHideOnNull = true;

    public BadgeViewNotAccurate(Context context) {
        this(context, null);
    }

    public BadgeViewNotAccurate(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public BadgeViewNotAccurate(Context context, AttributeSet attrs, int defStyle) {
